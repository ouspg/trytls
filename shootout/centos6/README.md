...
---------- | ---------------- | --------------- | -------------- | ---------- | ---------- | -------- | ---------------------
CentOS 6.8 | NO SNI           | ERROR           | FAIL           | ERROR      | PASS       | PASS     | NO SNI
...
platform: Linux
runner: trytls 0.3.0 (CPython 3.4.2, OpenSSL 1.0.1e-fips)
stub: /usr/bin/python python2-requests/run.py
 ...
 PASS valid localhost certificate [accept localhost:41913]
      output: /usr/lib/python2.6/site-packages/urllib3/connection.py:251: SecurityWarning: Certificate has no `subjectAltName`, falling back to check for a `commonName` for now. This feature is being removed by major browsers and deprecated by RFC 2818. (See https://github.com/shazow/urllib3/issues/497 for details.)  SecurityWarning
 PASS invalid localhost certificate [reject localhost:45688]
      output: /usr/lib/python2.6/site-packages/urllib3/connection.py:251: SecurityWarning: Certificate has no `subjectAltName`, falling back to check for a `commonName` for now. This feature is being removed by major browsers and deprecated by RFC 2818. (See https://github.com/shazow/urllib3/issues/497 for details.)  SecurityWarning
...
stub: python python3-urllib/run.py
 ...
 PASS protection against POODLE attack [reject sslv3.dshield.org:443]
 PASS eDellRoot CA #2 [reject badcert-edell.tlsfun.de:443]
 PASS valid localhost certificate [accept localhost:45718]
 PASS invalid localhost certificate [reject localhost:44062]
 PASS use only the given CA bundle, not system's [reject sha256.badssl.com:443]
```
...
ERROR protection against POODLE attack [reject sslv3.dshield.org:443]
 ...
 PASS eDellRoot CA #2 [reject badcert-edell.tlsfun.de:443]
 SKIP valid localhost certificate [accept localhost:44559]
 SKIP invalid localhost certificate [reject localhost:32824]
...
stub: java -classpath java-https Run
 ...
 PASS eDellRoot CA #2 [reject badcert-edell.tlsfun.de:443]
      output: javax.net.ssl.SSLHandshakeException: sun.security.validator.ValidatorException: PKIX path building failed: sun.security.provider.certpath.SunCertPathBuilderException: unable to find valid certification path to requested target
 SKIP valid localhost certificate [accept localhost:38847]
 SKIP invalid localhost certificate [reject localhost:34156]
 SKIP use only the given CA bundle, not system's [reject sha256.badssl.com:443]
```
...
stub: java -classpath java-net Run
 ...
 PASS eDellRoot CA #2 [reject badcert-edell.tlsfun.de:443]
      output: javax.net.ssl.SSLHandshakeException: sun.security.validator.ValidatorException: PKIX path building failed: sun.security.provider.certpath.SunCertPathBuilderException: unable to find valid certification path to requested target
 SKIP valid localhost certificate [accept localhost:40609]
 SKIP invalid localhost certificate [reject localhost:45593]
 SKIP use only the given CA bundle, not system's [reject sha256.badssl.com:443]
```
...
stub: php php-file-get-contents/run.php
 ...
 PASS protection against POODLE attack [reject sslv3.dshield.org:443]
 PASS eDellRoot CA #2 [reject badcert-edell.tlsfun.de:443]
 SKIP valid localhost certificate [accept localhost:44107]
 SKIP invalid localhost certificate [reject localhost:37562]
 SKIP use only the given CA bundle, not system's [reject sha256.badssl.com:443]
```
