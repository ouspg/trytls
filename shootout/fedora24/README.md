...
runner: trytls 0.3.4 (CPython 2.7.12, OpenSSL 1.0.2h-fips)
stub: python python2-requests/run.py
 ...
 PASS valid localhost certificate [accept localhost:33081]
 ...
 PASS invalid localhost certificate [reject localhost:43272]
      output: /usr/lib/python2.7/site-packages/requests/packages/urllib3/connection.py:303: SubjectAltNameWarning: Certificate for localhost has no `subjectAltName`, falling back to check for a `commonName` for now. This feature is being removed by major browsers and deprecated by RFC 2818. (See https://github.com/shazow/urllib3/issues/497 for details.)  SubjectAltNameWarning
...
stub: python python2-urllib2/run.py
 ...
 PASS denies use of MD5 signature algorithm (RFC6151) [reject weak-sig.badtls.io:11004]
 PASS denies use of RC4 with MD5 ciphers [reject rc4-md5.badtls.io:11009]
 PASS valid localhost certificate [accept localhost:46192]
 PASS invalid localhost certificate [reject localhost:39201]
 PASS use only the given CA bundle, not system's [reject sha256.badssl.com:443]
```
...
stub: python3 python3-urllib/run.py
 ...
 PASS denies use of MD5 signature algorithm (RFC6151) [reject weak-sig.badtls.io:11004]
 PASS denies use of RC4 with MD5 ciphers [reject rc4-md5.badtls.io:11009]
 PASS valid localhost certificate [accept localhost:39938]
 PASS invalid localhost certificate [reject localhost:43688]
 PASS use only the given CA bundle, not system's [reject sha256.badssl.com:443]
```
...
stub: go-nethttp/run
 ...
 SKIP valid localhost certificate [accept localhost:33024]
 SKIP invalid localhost certificate [reject localhost:42673]
...
stub: java -classpath java-https Run
 ...
 SKIP denies use of MD5 signature algorithm (RFC6151) [reject weak-sig.badtls.io:11004]
 SKIP denies use of RC4 with MD5 ciphers [reject rc4-md5.badtls.io:11009]
 SKIP valid localhost certificate [accept localhost:35236]
 SKIP invalid localhost certificate [reject localhost:35937]
 SKIP use only the given CA bundle, not system's [reject sha256.badssl.com:443]
```
...
stub: java -classpath java-net Run
 ...
 SKIP denies use of MD5 signature algorithm (RFC6151) [reject weak-sig.badtls.io:11004]
 SKIP denies use of RC4 with MD5 ciphers [reject rc4-md5.badtls.io:11009]
 SKIP valid localhost certificate [accept localhost:39342]
 SKIP invalid localhost certificate [reject localhost:37072]
 SKIP use only the given CA bundle, not system's [reject sha256.badssl.com:443]
```
...
stub: php php-file-get-contents/run.php
 ...
 SKIP denies use of MD5 signature algorithm (RFC6151) [reject weak-sig.badtls.io:11004]
 SKIP denies use of RC4 with MD5 ciphers [reject rc4-md5.badtls.io:11009]
 SKIP valid localhost certificate [accept localhost:40014]
 SKIP invalid localhost certificate [reject localhost:34768]
 SKIP use only the given CA bundle, not system's [reject sha256.badssl.com:443]
```
