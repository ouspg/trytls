...
* After shootdown 0.2 Python developers ([python-dev link](https://mail.python.org/mailman/listinfo/python-dev)) have been contacted. The distribution depency of TLS certificate verification is known and the backward compatibility issues required not enabling this by
default for older versions. Administrators have the possibility to add support per-case. More information can be found [here](https://github.com/ouspg/trytls/blob/master/doc/discussion-tracking.md#python-dev).
